		...
		<v-card class="elevation-12">
			<v-toolbar dark color="primary" v-if="formState < 2">
				<v-toolbar-title>
					...
					<span> | </span>
					<a class="login-header" v-bind:class="[formState == 1 ? 'active-login-header' : '']" href="" @click.prevent="formState=1">Registration</a>
				</v-toolbar-title>
				<v-spacer></v-spacer>
				<v-tooltip bottom>
					...
					<v-card>
						<v-card-title primary-title>
							<div>
								...
								<p>На ваш e-mail {{ email }} выслано письмо с активацией аккаунта,
